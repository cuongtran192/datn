...
<div class="container">
    ...
    <h2 style="color: black; font-size: 30px; margin-top: 40px;">LAPTOP LENOVO </h2>
...
<div class="d-inline-block rounded-pill bg-light p-0">
        ...
        $sql = "SELECT * FROM product WHERE brand_id='5' AND type_id='1'";
        if ($sort == 'asc') {
...
<div class="d-inline-block rounded-pill bg-light p-0">
        ...
        $sort = isset($_GET['sort']) ? $_GET['sort'] : '';
        $sql = "SELECT * FROM product WHERE brand_id='5'";
        if ($sort == 'asc') {
            $sql .= " ORDER BY price ASC";
        } elseif ($sort == 'desc') {
            $sql .= " ORDER BY price DESC";
